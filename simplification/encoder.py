...
def get_encoder_layer(embed_seq, input_data, rnn_size, num_layers,
                   ...
                   encoding_embedding_size, initial_state=None):
    ...
    #print(encoder_embed_input.shape)
    ...
    encoder_output, encoder_state = tf.nn.dynamic_rnn(cell, encoder_embed_input, initial_state=initial_state,
