...
if __name__ == '__main__':
    ...
    pickle.dump(int_words, open(path2+'int_words', 'wb'), protocol=2)
            ...
            for x, y in batches:
                ...
                if iteration % 1000 == 0:
                    ...
                    for i in range(valid_size):
                        ...
                        #print(log)
                iteration += 1
        save_path = saver.save(sess, path2+"checkpoints/ogm.ckpt")
        embed_mat = sess.run(normalized_embedding)
    
    pickle.dump(embed_mat, open(path2+'embed_mat', 'wb'), protocol=2)
    viz_words = 100
    tsne = TSNE()
