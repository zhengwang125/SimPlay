...
if __name__ == '__main__':
    ...
    #cor_ogm_train_data = ogm_train_data=pickle.load(open(path2+'drop_ogm_train_data', 'rb'), encoding='bytes') #for drop version
    cor_ogm_train_data = ogm_train_data=pickle.load(open(path2+'noise_ogm_train_data', 'rb'), encoding='bytes') #for noise version
